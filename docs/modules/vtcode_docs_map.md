...
- **File**: `docs/development/compaction.md`
  ...
  - **User Questions**: "What can you tell me about Compaction Engine?", "How does Strategy dispatch work?", "How does Anthropic context-edit ladder work?"
...
- **File**: `docs/project/PLAN-compaction-summary-fix.md`
  - **Content**: PLAN: `/compact` "Failed to generate compaction summary"
  - **Topics**: Root cause, Evidence, Changes applied, Remaining work, Gotchas discovered
  - **User Questions**: "What can you tell me about PLAN: `/compact` \"Failed to generate compaction summary\"?", "How does Root cause work?", "How does Evidence work?"
...
- **File**: `docs/user-guide/commands.md`
  ...
  - **User Questions**: "What can you tell me about Command Reference?", "How does Core command reference work?", "How does Headless / CI work?"
