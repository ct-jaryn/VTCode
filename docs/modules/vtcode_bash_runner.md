...
break out of quoting contexts.F:crates/codegen/vtcode-bash-runner/src/runner.rs†L1-L229F:crates/codegen/vtcode-bash-runner/src/runner.rs†L344-L372
...
their environment.F:crates/codegen/vtcode-bash-runner/src/executor.rs†L1-L470
...
an allowlist of permitted command categories.F:crates/codegen/vtcode-bash-runner/src/policy.rs†L1-L73
...
deployments that restrict shell access.F:crates/codegen/vtcode-bash-runner/src/executor.rs†L204-L356
...
dashboards or persisted alongside other execution telemetry.F:crates/codegen/vtcode-bash-runner/src/executor.rs†L358-L470
